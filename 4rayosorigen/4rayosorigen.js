...
var drawCanvas = function(rotarPlano, anguloQ, anguloL, colorRectas, colorArcos) {
  ...
  var anguloT = 180;
  var anguloP = 180-anguloQ;

  anguloQ = parseInt(anguloQ);
  ...
  // ArcT
  ctx.beginPath();
  ctx.arc(0,0,arcsRadius*0.8,(90)*Math.PI/180,(90+anguloT)*Math.PI/180,false)
  ctx.stroke();
  ctx.closePath();
